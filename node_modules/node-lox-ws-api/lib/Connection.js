...
var Connection = function (host, keepalive, secure) {
    this._host = host;
    ...
    // FIX HTTPS: bij secure gaat de websocket over wss://. Het Miniserver-cert
    // is uitgegeven op {snr}.dns.loxonecloud.com en matcht nooit het lokale IP,
    // dus certificaatvalidatie staat uit voor deze verbinding.
    this._secure = !!secure;
    this._ws_url = (this._secure ? 'wss://' : 'ws://') + host + '/ws/rfc6455';
    this._ws = {
        'client': new WebSocketClient(this._secure ? { 'tlsOptions': { 'rejectUnauthorized': false } } : undefined),
